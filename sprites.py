...
class Player(pg.sprite.Sprite):
    def __init__(self, game, x, y):
        # Defines sprite layer and adds object to sprite groups
        self._layer = PLAYER_LAYER
        self.groups = game.all_sprites

        # Initializes object sprite-object with object groups
    ...
    def shoot(self):
        ...
        if now - self.last_shot > WEAPONS[self.weapon]['rate']:
            ...
            for i in range(WEAPONS[self.weapon]['bullet_count']):
                # Calculate spread and spawn bullet
...
class Mob(pg.sprite.Sprite):
    ...
    def update(self):
        ...
        # If distance small enough, then mob will attack
        if target_dist.length_squared() < DETECT_RADIUS**2:
            # Chance per frame to play zombie sound
            if random() < 0.002:
            ...
            # Calculates direction vector whilst avoiding other mobs
            self.avoid_mobs()
        ...
        # If takes damaged and killed
        if self.health <= 0:
            choice(self.game.zombie_hit_sounds).play()  # Playe sound
            self.kill()                                 # Delete Zombie object
            self.game.map_img.blit(self.game.splat, self.pos - vec(32, 32))

    def avoid_mobs(self):
        # Finds vectors between self and other mobs then adds them to own direction vector to move away from them
    ...
    def draw_health(self):
        ...
        # Creates health_bar rect and draws it if health below 100%
...
class Bullet(pg.sprite.Sprite):
    def __init__(self, game, pos, dir, damage):
        ...
        self.pos = vec(pos)  # VEC class used to make copy of players "pos" to be used here
